...
public class test_CookiesLog {
	...
	public void test1() throws IOException {
		...
		String answer = x.getMostActiveCookies(new Date("2022-01-31"));
	...
	public void test2() throws IOException {
		...
		String answer2 = x.getMostActiveCookies(new Date("2022-01-30"));
		String correctAnswer2 = "D\nE";
		assertEquals(answer2, correctAnswer2);
		
		String answer3 = x.getMostActiveCookies(new Date("2022-01-29"));
